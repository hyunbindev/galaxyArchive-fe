...
import getArticle from "@/app/(main)/article/[id]/getArticle";
...
export default async function Page({ params }: { params: { id: string } }){
    ...
    const article:any = await getArticle(numericId)
        ...
        <main className=" max-w-4xl mx-auto bg-background pb-20">
            ...
            <div className="flex-col">
                <div className="w-full flex flex-col pt-10">
                    ...
                    <div className="flex items-center gap-3 py-4">
                        ...
                        <span className="text-md">hyunbindev</span>
                    </div>
                </div>
            </div>
            ...
            <div className="milkdown editor prosemirror-virtual-cursor-animation">
                <div className="prose dark:prose-invert max-w-none">
                    <MilkdownViewer text={article.data.text}/>
                </div>
            </div>
        </main>
    )
