...
export default function ArticleSummaryElement({articleSummary}:ArticleSummaryElementProps){
    ...
    return(
        <Link href={`/article/${articleSummary.id}`}>
            <div className="h-40 flex flex-col justify-between border rounded-sm px-3 py-6 hover:bg-zinc-100 dark:hover:bg-zinc-900 cursor-pointer">
                ...
                <span className="text-sm text-muted-foreground mb-3">{articleSummary.description}</span>
